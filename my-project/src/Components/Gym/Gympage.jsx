...
import { productGym } from "./productGym";
...
function Gympage() {
  ...
  return (
    <Container className="mt-4 mb-3">
      <h4>
        Buy Gym Collection Online <span style={{ fontSize: "13px", color: "gray" }}>* 286,130 items</span>
      </h4>
            ...
            <Col key={item.id} lg={3} md={6}>
              <Card className="cus-card mt-3">
                ...
                <Card.Title>
                  ...
                  <h4 className="p-0 m-0">{item.brand}</h4>
                  <p className="fs-6 m-0">{item.desc}</p>
                  <h6 className="fs-5">
                    ${item.price}{" "}
                ...
                <div className="gap-2 d-flex justify-content-center">
                  ...
                  <Button variant="success" onClick={() => setSelectedProduct(item)}>Shop Now</Button>
                </div>
              </Card>
            </Col>
          );
